...
" 常规模式下输入 F2 调用插件
nmap <F2> :SrcExplToggle<CR>                "打开/闭浏览窗口
...
let g:SrcExpl_gobackKey = "<BACKSPACE>" 
...
" -----------------------------------------------------------------------------
" 常规模式下输入 F8 更新tag文件
map <F8> :!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q .<CR>	"更新tag文件
"set tags=/usr/tags							"设置tag文件的搜索路径
